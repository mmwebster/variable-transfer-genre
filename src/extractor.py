# Credit:
# This feature extractor file was copied from the project
...
os.environ['AUDIO_DIR'] = audio_dir # @TODO need this?

print('Loading tracks.csv and genres.csv...')
tracks = fma_utils.load(os.path.join(metadata_dir, 'tracks.csv'))
genres = fma_utils.load(os.path.join(metadata_dir, 'genres.csv'))
